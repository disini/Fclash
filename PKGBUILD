...
install=
changelog=
source=("${pkgname%-git}::git+https://github.com/Kingtous/Fclash.git#branch=stable" "https://github.com/Kingtous/Fclash/releases/download/v1.3.3/cn.kingtous.fclash.deb")
noextract=()
